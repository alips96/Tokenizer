...
{
    public class EnglishNomState : IGetBackToInitialState
    {
        MainForm mainForm;
        public EnglishNomState(MainForm _mainForm)
        {
            mainForm = _mainForm;
        }
        ...
        {
            mainForm.tokensList.Add(new Token(mainForm.currentToken, "English Nom Token"));
            mainForm.currentToken = null;
        }
