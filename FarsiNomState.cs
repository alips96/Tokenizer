...
{
    public class FarsiNomState : IGetBackToInitialState
    {
        MainForm mainForm;
        public FarsiNomState(MainForm _mainForm)
        {
            mainForm = _mainForm;
        }
        ...
        {
            mainForm.tokensList.Add(new Token(mainForm.currentToken, "Farsi Nom Token"));
            mainForm.currentToken = null;
        }
